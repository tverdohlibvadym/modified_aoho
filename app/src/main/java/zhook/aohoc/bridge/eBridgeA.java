...
public interface eBridgeA {
    ...
    void a(fBridgeA fBridgeAVar, int i, int i2, int i3);

    void a(fBridgeA fBridgeAVar, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8);
